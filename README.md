...
| Design Name | TNS (ns) | Dynamic Power (mW) | Leakage Power (mW) | Cap Over Sum | Slew Over Sum | Fanout Over Sum | Max GR Overflow | Total GR Overflow | Tool Runtime | Flow Runtime | Avg Disp (dbu) | Design Score |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
